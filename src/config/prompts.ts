...
function createRollbackAugmentation(request: TaReplyRequest): { system: readonly string[]; user: readonly string[] } {
...
function withRollbackAugmentation(
  ...
  base: { system: readonly string[]; user: readonly string[] }
